...
def depthFirstSearch(problem):
    ...
    ## initialize pacman node
    current_node = dict()
    current_node['state'] = problem.getStartState()
    ...
    while not problem.isGoalState(current_node['state']):
        ...
        for s in successors:
            ...
            if state not in closed:
                ...
                node['g'] = cost + current_node['g']
                open.push(node)
        node = open.pop()
        while node['state'] in closed:
            node = open.pop()
        current_node = node
    ...
    while not problem.isGoalState(current_node['state']):
        ...
        for s in successors:
            ...
            if state not in closed:
                ...
                node['parent'] = current_node
                node['g'] = cost + current_node['g']
                open.push(node, node['g'] + heuristic(state, problem))
        node = open.pop()
        while node['state'] in closed:
            node = open.pop()
        current_node = node
